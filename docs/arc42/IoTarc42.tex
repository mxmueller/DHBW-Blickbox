...
Der Technische Kontext beschreibt welche Schnittstellen und Komponenten zum 
gelingen des Projekts beitragen. Zusätzlich die Systeme beschrieben, die das
System umgeben.

\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{./resources/ArchitekturDiagramBlickbox-detail.drawio.pdf}
  \caption{Übersichtsbild über die Schnittstellen, Hardware, als auch Softwarekomponenten.}
  \label{fig:projekt-uebersicht}
\end{figure}
