...
| **Erweiterbarkeit & Wartung**                                 | Modularer Projektaufbau und Tests                   | Damit Dritte, sei es irgendwelche Stakeholder oder neue Entwickler, sich in das Projekt leicht einarbeiten können, bauen wir das Projekt so auf, dass Codekomponenten voneinander getrennt aufgebaut sind. <br> Sie befinden sich in Modulen. <br> Zudem sind Funktionen getestet. |   
