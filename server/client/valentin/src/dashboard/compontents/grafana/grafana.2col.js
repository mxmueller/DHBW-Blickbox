...
function GrafanaValidation({ children }) {
  ...
  useEffect(() => {
    ...
    const urls = [
      process.env.REACT_APP_GRAFANA_URL_2COL_1 || "https://dhbwgrafana.maytastix.de/public-dashboards/fc8daf716c5545abafe35e81ca78c8b0",
      process.env.REACT_APP_GRAFANA_URL_2COL_2 || "https://dhbwgrafana.maytastix.de/public-dashboards/ac794c5a60b04f818cf6754246f32b0e",
    ]
  ...
  const MockComponent = ({ index }) => {
    const data = [
      { name: 'Gruppe A', value: 400 - index * 100 },
      { name: 'Gruppe B', value: 300 + index * 50 },
      { name: 'Gruppe C', value: 300 },
      { name: 'Gruppe D', value: 200 + index * 60 },
    ]
